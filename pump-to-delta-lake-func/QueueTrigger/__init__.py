...
def main(event: func.QueueMessage) -> None:
    ...
    try:
        ...
        # Sleeping for PUSH_INTERVAL_IN_SECONDS second, to ensure all events belonging to current bucket have arrived
        time.sleep(PUSH_INTERVAL_IN_SECONDS)
